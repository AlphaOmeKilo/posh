...
<html <?php language_attributes() ?>>
  <head>
    ...
    <?php if ( ENVIRONMENT == 'development' ): ?>
      <link rel="stylesheet" href="<?php posh_include( 'dist/css/application.css', true ) ?>" type="text/css" media="screen">
    <?php else: ?>
      <link rel="stylesheet" href="<?php posh_include( 'dist/css/application.min.css', true ) ?>" type="text/css" media="screen">
    <?php endif ?>
